...
public class RefreshLayout extends ViewGroup {
    ...
    private int maxDragDistance; //最大下拉距离
    private int activePointerId; //过滤多点触控
    ...
    public RefreshLayout(Context context, AttributeSet attrs) {
        ...
        // 添加默认的头部
        SimpleHeaderView header  = new SimpleHeaderView(context);
    ...
    private void changeState(State state) {
        this.state = state;
        IRefreshHeader refreshHeader = this.refreshHeader instanceof IRefreshHeader ? ((IRefreshHeader) this.refreshHeader) : null;
